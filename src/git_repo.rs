...
pub fn switch_to(repo: &Repository, branch: &str) -> Result<(), Error> {
...
pub fn commit(repo: &Repository, branch: &str, message: String) -> Result<Oid, Error> {
  // Stage all files
...
pub fn push_to_remote(repo: &Repository, branch: &str) -> Result<(), Error> {
